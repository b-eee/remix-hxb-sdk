...
export default function ModalConfirmDeleteDs({ setHiddenConfirm, actionData, dsDetail }: ModalProps) {
  ...
  return (
    <>
      ...
      <div id='authentication-modal' tabIndex={-1} aria-hidden='true' className={`${open} md:w-2/3 lg:w-1/3 w-full overflow-y-auto overflow-x-hidden fixed z-50 inset-0 m-auto max-h-max h-auto bg-gray-400`}>
